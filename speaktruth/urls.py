...
urlpatterns = [
    ...
    path("api/<int:path("dashboard/songleader-app/", songleader_app_info, name="songleader_app_info")year>/<int:month>/<int:day>/", api_assignments_for_day, name="api_assignments_for_day"),
